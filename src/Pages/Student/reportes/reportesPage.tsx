...
export default function ReportesPage() {
  ...
  // Datos ficticios para reportes (actualizados con datos reales donde corresponde)
      ...
      <div className="container mx-auto">
        ...
        <Tabs defaultValue="actual" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4 gap-2 bg-transparent p-0">
            <TabsTrigger
              value="actual"
              className="px-6 py-3 rounded-lg text-sm font-medium transition-all duration-200 border-2 data-[state=active]:bg-blue-600 data-[state=active]:text-white data-[state=active]:border-blue-600 data-[state=active]:shadow-lg data-[state=inactive]:bg-white data-[state=inactive]:text-gray-700 data-[state=inactive]:border-gray-300 data-[state=inactive]:hover:border-blue-300 data-[state=inactive]:hover:bg-blue-50"
            >
              Reporte Actual
            </TabsTrigger>
            <TabsTrigger
